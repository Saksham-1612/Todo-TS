...
function InputFeild({ todo, setTodo, handleAdd }: PropsTypes) {
  return (
    <form className="flex items-center justify-center" onSubmit={handleAdd}>
      ...
      />
      <button
        className=" absolute right-20 sm:right-32 md:right-[12.5rem] lg:right-[16.5rem] xl:right-[23rem] 2xl:right-[30.5rem]  shadow-lg text-white bg-orange-500 w-16 h-16 rounded-full "
        type="submit"
      >
        Add
      </button>
